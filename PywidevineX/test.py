...
cert=requests.post(license_url, headers=headers, data=b'\x08\x04').content
...
license=requests.post(license_url,headers=headers, data=challenge).content
print(license)
print(base64.b64encode(license).decode())
